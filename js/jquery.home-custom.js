...
Weebly.mobile_navigation = (function($) {
  ...
  var initMenu = function() {
      ...
      $sideMenus.each(function() {
        ...
        var $backLink = $('<li class="wsite-menu-back-item">' + '<a><span class="wsite-menu-mobile-arrow"></span><span class="wsite-menu-back"><i class="fa fa-chevron-left" aria-hidden="true"></i>Back</span></a>' + '</li>');
        ...
        $parentAnchor.append('<span class="wsite-menu-mobile-arrow"><i class="fa fa-chevron-right" aria-hidden="true"></i></span>');
...
/* Equal Author: Daniel Tapias Morales */ 
...
function backgroundResize(){
    ...
    $(".wft-background").each(function(i){
        var path = $(this);
        // variables
